        ...
        <>
            <Modal isOpen={true} onRequestClose={close} className="mymodal" overlayClassName="myoverlay">
                <div className="row">
                    <div className="col-sm-4">
                        <h1 className="title-sport"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
			...
			L451.979,481.999H316.703V238.198h135.276V481.999z M469.52,208.197H316.703v-85.214H469.52V208.197z"></path>
                    ...
                    <div className="col-sm-8">
                        <form action="/ajax/signup-new.php" id="signupForm" method="post" className="form-signUp clearForm">
